...
const SENSORS = [
  { id: 1, name: 'Humidity Sensor 1', currentHum: 35, location: 'Located inside at frame No. 5' },
  { id: 2, name: 'Humidity Sensor 2', currentHum: 35, location: 'Located inside at frame No. 5' },
  { id: 3, name: 'Humidity Sensor 3', currentHum: 35, location: 'Located inside at frame No. 5' },
];

const SensorCard = ({ sensor }) => {
  const [minHum, setMinHum] = useState(35);
  const [maxHum, setMaxHum] = useState(40);
    ...
    <View style={[styles.card, { borderColor: theme.purple }]}>
      ...
      <View style={styles.alertRow}>
        ...
        <View style={styles.tempControls}>
          ...
          <View style={styles.spinnerContainer}>
            <Text style={styles.spinnerValue}>{sensor.min_value}</Text>
            <View style={styles.spinnerButtons}>
              <TouchableOpacity onPress={() => setMinHum(v => v + 1)} style={styles.spinnerBtn}>
          ...
          <View style={styles.spinnerContainer}>
            ...
            <View style={styles.spinnerButtons}>
              <TouchableOpacity onPress={() => setMaxHum(v => v + 1)} style={styles.spinnerBtn}>
                <Ionicons name="caret-up" size={10} color="#6B3FA0" />
              </TouchableOpacity>
              <TouchableOpacity onPress={() => setMaxHum(v => v - 1)} style={styles.spinnerBtn}>
                <Ionicons name="caret-down" size={10} color="#6B3FA0" />
      ...
      <View style={styles.tempRow}>
        <Text style={styles.currentTempLabel}>
          Current Temp: <Text style={styles.currentTempValue}>{sensor.currentHum}%</Text>
        </Text>
