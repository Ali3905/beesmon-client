...
// const SENSORS = [
//   { id: 1, name: 'Temprature Sensor 1', currentTemp: 35, location: 'Located inside at frame No. 5' },
//   { id: 2, name: 'Temprature Sensor 2', currentTemp: 35, location: 'Located inside at frame No. 5' },
//   { id: 3, name: 'Temprature Sensor 3', currentTemp: 35, location: 'Located inside at frame No. 5' },
// ];

const SensorCard = ({ sensor }) => {
  const [minTemp, setMinTemp] = useState(35);
  ...
  return (
    <View style={[styles.card, { borderColor: theme.purple }]}>
      ...
      <View style={styles.alertRow}>
        <Text style={styles.alertLabel}>Alert (°C):</Text>
        ...
        <View style={styles.tempControls}>
          ...
          <View style={styles.spinnerContainer}>
            ...
            <View style={styles.spinnerButtons}>
              <TouchableOpacity onPress={() => setMinTemp(v => v + 1)} style={styles.spinnerBtn}>
      ...
      <View style={styles.tempRow}>
        <Text style={styles.currentTempLabel}>
          Current Temp: <Text style={styles.currentTempValue}>{sensor.currentTemp}°C</Text>
        </Text>
